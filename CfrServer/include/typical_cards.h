...
class TypicalCards {
 public:
  TypicalCards(void) {}
  TypicalCards(int n, const Card *previous, int num_previous, int previous_suit_groups,
		 bool maintain_suit_groups);
  virtual ~TypicalCards(void);
  static bool ToTypical2(const Card *cards, int num_cards,
		       int suit_groups, Card *canon_cards);
  static void ToTypical(const Card *cards, int num_cards,
		      int suit_groups, Card *canon_cards);
