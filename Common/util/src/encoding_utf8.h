...
#ifndef __UTF8_ENCODING_H__
#define __UTF8_ENCODING_H__
...
namespace dtutil
{
    ...
    */
    ...
    private:
        ...
        * \brief 拷贝构造函数
        */
        UTF8Encoding(const UTF8Encoding &);

        /**
        * \brief =赋值重载
        */
        UTF8Encoding& operator = (const UTF8Encoding &);

    private:
        void    *m_pToUTF8;         ///< 其它编码转换成UTF8编码
        void    *m_pFromUTF8;       ///< UTF8编码转换成其它编码
    };
}

#endif // __UTF8_ENCODING_H__